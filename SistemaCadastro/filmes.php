...
<html>
  ...
  <body>
    ...
    <div class="container">
    <h2> Filmes </h2>
     <form class="form-signin" method="POST" action="remover.php" enctype="multipart/form-data">
  ...
  <div class="input-group">
    <div class="form-group">
      <label for="viagem_list">Selecione o Filme Cadastrado (Lançamento):</label>
      ...
      $sql = "SELECT identificador,nome FROM Filmes";
