...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-fixed-top navbar-inverse">
      ...
      <ul class="nav navbar-nav">
       ...
       <li class="active"><a href="filmes_breves.php">Visualizar Comentários</a></li>
       </ul>
      </div>
  </nav>
    ...
    <div class="container">
    <h2> Comentários </h2>
     <form class="form-signin" method="POST" action="remover_comentario.php" enctype="multipart/form-data">
  ...
  <div class="input-group">
    <div class="form-group">
      <label for="viagem_list">Selecione um Comentário:</label>
      <select class="form-control" id="viagem_list" name="viagem_list" onchange="carregarcomentario()">
      <?php
      ...
      $sql = "SELECT identificador,usuario FROM Comentarios";
      $result = mysql_query($sql);

      while ($row = mysql_fetch_array($result)) {
          echo "<option value = " . $row['identificador']. ">ID: " . $row['identificador']. " / Nome do Usuario: " .$row['usuario']. "</option>";
      }
      ?>
      </select>
    </div>
  ...
  <!-- HOMEPAGE -->
    <div class="form-group">
        <span class="input-group-addon" id="basic-addon-three">Id do Comentário</span>
